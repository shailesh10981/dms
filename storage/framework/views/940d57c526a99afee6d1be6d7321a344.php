        ...
        <div class="tab-pane fade show active" id="general" role="tabpanel">
          <div class="form-group">
            ...
            <input type="text" name="general[app_name]" id="app_name"
              class="form-control" value="<?php echo e($settings['general']['app_name']); ?>">
          </div>
          ...
          <div class="form-group">
            ...
            <select name="general[timezone]" id="timezone" class="form-control select2">
              ...
              <option value="<?php echo e($tz); ?>" <?php echo e($settings['general']['timezone'] == $tz ? 'selected' : ''); ?>>
                <?php echo e($tz); ?>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select name="general[time_format]" id="time_format" class="form-control">
                  <option value="H:i:s" <?php echo e($settings['general']['time_format'] == 'H:i:s' ? 'selected' : ''); ?>>24-hour (14:30:00)</option>
                  <option value="h:i:s A" <?php echo e($settings['general']['time_format'] == 'h:i:s A' ? 'selected' : ''); ?>>12-hour (02:30:00 PM)</option>
                </select>
              </div>
            </div>
          </div>
        ...
        <div class="tab-pane fade" id="mail" role="tabpanel">
          <div class="form-group">
            ...
            <input type="text" name="mail[mail_from_name]" id="mail_from_name"
              class="form-control" value="<?php echo e($settings['mail']['mail_from_name']); ?>">
          </div>

          <div class="form-group">
            <label for="mail_from_address">From Address</label>
            <input type="email" name="mail[mail_from_address]" id="mail_from_address"
              class="form-control" value="<?php echo e($settings['mail']['mail_from_address']); ?>">
          </div>
        </div>
        ...
        <div class="tab-pane fade" id="document" role="tabpanel">
          <div class="form-group">
            ...
            <input type="number" name="document[document_retention_days]" id="document_retention_days"
              class="form-control" value="<?php echo e($settings['document']['document_retention_days']); ?>" min="1">
          </div>

          <div class="form-group">
            <label for="max_file_size">Maximum File Size (MB)</label>
            <input type="number" name="document[max_file_size]" id="max_file_size"
              class="form-control" value="<?php echo e($settings['document']['max_file_size']); ?>" min="1" max="50">
          </div>
          ...
          <div class="form-group">
            ...
            <select name="document[allowed_file_types][]" id="allowed_file_types"
              ...
              ?>
              <option value="pdf" <?php echo e(in_array('pdf', $allowedTypes) ? 'selected' : ''); ?>>PDF</option>
              <option value="doc" <?php echo e(in_array('doc', $allowedTypes) ? 'selected' : ''); ?>>DOC</option>
              <option value="docx" <?php echo e(in_array('docx', $allowedTypes) ? 'selected' : ''); ?>>DOCX</option>
              <option value="xls" <?php echo e(in_array('xls', $allowedTypes) ? 'selected' : ''); ?>>XLS</option>
              <option value="xlsx" <?php echo e(in_array('xlsx', $allowedTypes) ? 'selected' : ''); ?>>XLSX</option>
              <option value="jpg" <?php echo e(in_array('jpg', $allowedTypes) ? 'selected' : ''); ?>>JPG</option>
              <option value="png" <?php echo e(in_array('png', $allowedTypes) ? 'selected' : ''); ?>>PNG</option>
              <option value="txt" <?php echo e(in_array('txt', $allowedTypes) ? 'selected' : ''); ?>>TXT</option>
            </select>
          </div>
        </div>
        ...
        <div class="tab-pane fade" id="compliance" role="tabpanel">
          <div class="form-group">
            ...
            <input type="number" name="compliance[default_due_days]" id="default_due_days"
              class="form-control" value="<?php echo e($settings['compliance']['default_due_days']); ?>" min="1">
          ...
          <div class="form-group">
            ...
            <input type="number" name="compliance[reminder_days_before]" id="reminder_days_before"
              class="form-control" value="<?php echo e($settings['compliance']['reminder_days_before']); ?>" min="1">
        ...
        <div class="tab-pane fade" id="notifications" role="tabpanel">
          <div class="form-check">
            <input type="checkbox" name="notifications[enable_email]" id="enable_email"
              class="form-check-input" value="1" <?php echo e($settings['notifications']['enable_email'] ? 'checked' : ''); ?>>
          ...
          <div class="form-check">
            <input type="checkbox" name="notifications[enable_sms]" id="enable_sms"
              class="form-check-input" value="1" <?php echo e($settings['notifications']['enable_sms'] ? 'checked' : ''); ?>>
          ...
          <div class="form-check">
            <input type="checkbox" name="notifications[enable_dashboard]" id="enable_dashboard"
              class="form-check-input" value="1" <?php echo e($settings['notifications']['enable_dashboard'] ? 'checked' : ''); ?>>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('components.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dms-ldap\resources\views/settings/index.blade.php ENDPATH**/ ?>